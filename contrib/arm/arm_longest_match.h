...
#include "deflate.h"
#include <stdint.h>
inline static long ZLIB_INTERNAL get_match_len(const unsigned char *a,
                                               const unsigned char *b, long max)
{
    int len = 0;
    unsigned long xor = 0;
 ...
 *
 */
inline static unsigned ZLIB_INTERNAL arm_longest_match(deflate_state *const s,
                                                       IPos cur_match) {
